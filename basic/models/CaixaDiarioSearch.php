...
/**
 * CaixaDiarioSearch represents the model behind the search form about `app\models\CaixaDiario`.
 */
class CaixaDiarioSearch extends CaixaDiario
{
    /**
     * @inheritdoc
     */
