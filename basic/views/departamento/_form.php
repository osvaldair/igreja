...
<div class="departamento-form">
    ...
    <?= $form->field($model, 'dirigente')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'qtde_integrantes')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'data_congresso')->textInput() ?>
